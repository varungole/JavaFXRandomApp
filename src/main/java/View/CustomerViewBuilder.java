...
public class CustomerViewBuilder implements Builder<Region> {
    ...
    private Node nameBox() {
        return new HBox(6, promptLabel("Name: "), boundTextField(model.customerName));
    }

    private Node accountBox() {
        return new HBox(6, promptLabel("Account: "), boundTextField(model.accountName));
    }
    ...
    public Node styledLabel(String contents, String styleClass) {
